...
'#
 ...
 export def "tutor2 expressions" [] {r#' 
...
'#
 ...
 export def "tutor2 shorthands" [] {r#' 
...
```'#
 ...
 export def "tutor2 list" [] {r#'  - tutor2
    - begin
    - tables
    - cells
    - expressions
